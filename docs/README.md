...
1.3.1 Paul Pfeiffer:
- Target Grade: 1,7
- Personal Goals: Sicherer Umgang mit APIs; Umsetzung einer App mit Frontend und Backend; Sicherer Umgang mit Creator-Views
1.3.2 Daniel Silbermann
  - Target Grade: 1,7
  - Personal Goals: Besseres Verständnis für Webapplikationen aneignen; Frontend und Backend implementieren
...
2.2 Plausible Problem:
  ...
  - Player von Musikquizzen können in der Regel nicht einfach ein eigenes Quiz erstellen und es veröffentlichen
...
2.3 Solution:
  ...
  - Player können Erfolge sharen, um eine kompetitive Dynamik zu kreieren
...
Seite A: Der „Quizmaster“ (Creator)
Aktion: Erstellt eigene Quiz-Pakete. Er sucht über die Spotify-API nach Songs, stellt ein Set zusammen (z. B. „Best of 90s Rap“) und gibt dem Quiz einen Namen
...
5. Leaderboard: Eine Übersicht, welcher User welches Quiz am schnellsten gelöst hat.
